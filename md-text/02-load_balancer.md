...
Використовуючи docker, docker-compose створіть інфраструктуру із п'яти серверів, між якими відбувається масштабування навантаження. Python використовувати заборонено. Всі інші технології(node, php, java, c#, go і т.д.)
