...
В результаті ми отримаємо дієспособну систему Ubuntu, в якій запущений bash. Всі команди, які ми почнемо зараз вводити будуть ви конуватися на Ubuntu. Наприклад, давайте виконаємо команду ls:
...
**Порада**: Ви можете обернути команду запуску проект в простій баш скрипт:
